  ...
  task create: :environment do 
    @sites = {
      ...
      "Car and Bike Accessories" => {
        url: "http://carandbike.lvh.me:3000", 
        color: "#44b5ca",
      ...
      "Shield & Protect" => {
        url: "http://shieldandprotect.lvh.me:3000", 
        color: "#EEC106",
      ...
      #  }, 
      "Outdoor Furniture" => {
        url: "http://furniture.lvh.me:3000", 
        color: "#0051ba",
      ...
      "Animal Feed" => {
        url: "http://animalfeed.lvh.me:3000", 
        color: "#B78A33",
      ...
      "Electronics" => {
        url: "http://electronics.lvh.me:3000", 
        color: "#007CC2",
